...
* `index.html` - The primary HTML file containing the content and structural markup for the menu card.
* `Assets/` - A dedicated directory housing any supplemental design resources, fonts, or images.
* `README.md` - Documentation and overview of the submission.
...
1. Clone the repository to your local system:
   ```bash
   git clone https://github.com/fizabaneen/Assignments-04---Ice-Cream-Menu-Card.git
   ```
2. Open the project folder:
   ```bash
   cd Assignments-04---Ice-Cream-Menu-Card
   ```
3. Open the `index.html` file in any standard web browser (such as Google Chrome, Mozilla Firefox, or Microsoft Edge) to render the menu interface.
